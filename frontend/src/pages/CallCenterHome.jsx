...
export default function CallCenterHome({
  ...
  const displayName = actingAs?.username || user?.username || "Call Center User";
  ...
  const dailyMessage = useMemo(() => {
    const messages = [
      "A well-organized start makes every booking smoother.",
      "Clear communication creates better patient experiences.",
      "Small accurate steps prevent bigger scheduling problems later.",
      "A calm workflow helps every patient feel supported.",
      "Consistency in booking keeps the clinic running well.",
      "Every correct booking saves time for the whole team.",
      "Good coordination starts with a clear dashboard.",
    ];
      ...
      <div style={styles.container}>
        ...
        <div style={styles.topBar}>
          <div style={styles.titleBlock}>
            <div style={styles.eyebrow}>Call Center</div>
        ...
        <div style={styles.grid}>
          <button
            type="button"
            style={styles.card}
            onClick={() => navigate("/callcenter/alerts")}
          >
            <div style={styles.cardContent}>
              ...
              <div style={styles.cardText}>
                Review alerts, priorities, and upcoming patient actions.
              </div>
          ...
          <button
            type="button"
            style={styles.card}
            onClick={() => navigate("/callcenter/booking")}
          >
            <div style={styles.cardContent}>
              <div style={styles.cardHeader}>
                <div>
              ...
              <div style={styles.cardText}>
                Search patients, book appointments, open new files, and manage booking trackers.
              </div>
