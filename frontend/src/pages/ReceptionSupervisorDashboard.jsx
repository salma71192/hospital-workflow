...
export default function ReceptionSupervisorDashboard({
  user,
  onLogout,
  actingAs,
  onStopImpersonation,
    ...
    <div style={styles.page}>
      <div style={styles.container}>
        ...
        <div style={styles.topBar}>
          <div>
            <h1 style={styles.title}>Reception Supervisor Dashboard</h1>
        ...
        <div style={styles.card}>
          <h2 style={styles.cardTitle}>Reception Overview</h2>
          <div style={styles.listItem}>Daily registrations — 28</div>
          <div style={styles.listItem}>Pending escalations — 4</div>
          <div style={styles.listItem}>Front desk staff on shift — 6</div>
        </div>
...
const styles = {
  page: { minHeight: "100vh", background: "linear-gradient(135deg, #eef4ff 0%, #f8fbff 100%)", padding: "32px 20px", fontFamily: "Arial, sans-serif" },
  ...
  title: { margin: 0, fontSize: "32px", fontWeight: "700", color: "#1e3a8a" },
  ...
  listItem: { padding: "12px 14px", border: "1px solid #bfdbfe", background: "#eff6ff", borderRadius: "10px", marginBottom: "10px", color: "#1e40af", fontWeight: "500" },
};