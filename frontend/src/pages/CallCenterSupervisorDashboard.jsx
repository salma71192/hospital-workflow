...
export default function CallCenterSupervisorDashboard({
  user,
  onLogout,
  actingAs,
  onStopImpersonation,
    ...
    <div style={styles.page}>
      <div style={styles.container}>
        ...
        <div style={styles.topBar}>
          <div>
            <h1 style={styles.title}>Call Center Supervisor Dashboard</h1>
        ...
        <div style={styles.card}>
          <h2 style={styles.cardTitle}>Call Center Overview</h2>
          <div style={styles.listItem}>Open call queue — 11</div>
          <div style={styles.listItem}>Resolved today — 32</div>
          <div style={styles.listItem}>Escalations — 5</div>
        </div>
...
const styles = {
  page: { minHeight: "100vh", background: "linear-gradient(135deg, #fdf2f8 0%, #fffafc 100%)", padding: "32px 20px", fontFamily: "Arial, sans-serif" },
  ...
  listItem: { padding: "12px 14px", border: "1px solid #fbcfe8", background: "#fdf2f8", borderRadius: "10px", marginBottom: "10px", color: "#9d174d", fontWeight: "500" },
};